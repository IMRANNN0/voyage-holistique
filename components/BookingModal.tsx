...
function SuccessView({ onClose }: { onClose: (reason?: BookingModalCloseReason) => void }) {
  ...
  return (
    <motion.div
      ...
      className="flex-1 overflow-y-auto px-5 py-8 text-center sm:px-7 sm:py-10 md:px-12 md:py-12"
    >
      {/* Checkmark */}
      ...
      <h3
        ...
        className="font-display mt-3 break-words text-3xl font-semibold leading-tight text-[#fbf4e8] sm:break-normal md:text-4xl"
      >
      ...
      >
        ...
        <a
          ...
          className="mt-4 inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-full bg-[#25D366] px-3 py-3 text-xs font-semibold uppercase tracking-[0.08em] text-white shadow-[0_8px_28px_rgba(37,211,102,0.35)] transition hover:bg-[#20bd5a] hover:shadow-[0_12px_36px_rgba(37,211,102,0.45)] focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2 focus:ring-offset-[#041B16] sm:px-6 sm:text-sm sm:tracking-[0.14em]"
        >
          ...
          <span className="truncate">Continuer sur WhatsApp</span>
        </a>
      </div>
